...
def main():
    ...
    prefix = ''
    test_name = 'best_model_comparison'
    ...
    for repetition in range(7):
        ...
        #
        # config = Config()
        # configuration_name = 'Custom word_id'
        # config.training.model_type = 'custom'
        ...
        #
        # config = Config()
        # configuration_name = 'Custom word_vec'
        # config.training.model_type = 'custom'
        # config.training.cnn_repetition = 2
        # config.training.lstm_repetition = 2
        # config.training.dense_repetition = 2
